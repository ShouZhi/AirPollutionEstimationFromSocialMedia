package bwaldvogel.liblinear;

import static bwaldvogel.liblinear.Linear.atof;
import static bwaldvogel.liblinear.Linear.atoi;
import static bwaldvogel.liblinear.Linear.closeQuietly;
import static bwaldvogel.liblinear.Linear.printf;
import static bwaldvogel.liblinear.Linear.info;
...
public class Predict {
     ...
     */
    static public void doPredict(BufferedReader reader, Writer writer, Model model) throws IOException {
        int correct = 0;
        int total = 0;
        double error = 0;
